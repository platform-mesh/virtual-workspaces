...
require (
	...
	github.com/kcp-dev/kcp v0.30.3
...
replace (
	...
	k8s.io/apiextensions-apiserver => github.com/kcp-dev/kubernetes/staging/src/k8s.io/apiextensions-apiserver v0.0.0-20260420103348-8d5156cdc917
